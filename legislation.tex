...
\begin{center}
  ...
  \\
  {\footnotesize \href{https://semver.org/}{Version 0.3}}
\end{center}
...
\begin{enumerate}[§ 1]
  ...
  \item Foodstuff not containing an appropriate amount of sugar or with an
    ...
    offering, COR will be obligated to procure proper \emph{cake}.

  \item \Cref{chp:circumstances} describes circumstances in which a traditional
    offering of \emph{cake}{} is expected by the \emph{cake offering
    responsible} (COR).  Individuals having undergone/undergoing any described
    circumstance are referred to as \emph{cake offering responsible}. Notice
    that \textbf{§12} is an exception.
...
\begin{enumerate}[§ 1]
  ...
  \item Being hit by a door/walking into a door.
