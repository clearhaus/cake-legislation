...
\begin{document}
    ...
    \begin{enumerate}[§ 1]
        ...
        \item Incident with a duration longer than 8 hours or requiring action from Clearhaus employees on duty outside of normal office hours, fully or primarily caused by upstream service provider (\emph{cake responsible organization} is Clearhaus A/S. The preferred type of cake for this rule is icecream).
    \end{enumerate}
\end{document}
