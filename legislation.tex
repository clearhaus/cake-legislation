...
\begin{document}
    ...
    \begin{enumerate}[§ 1]
        ...
        \item If network down > 15 min, or network down > 2 times on one day (calendar days, not 24 hours) Clearhaus will provide cake.
        ...
        \item Mass password reset by accident.
    \end{enumerate}
\end{document}
